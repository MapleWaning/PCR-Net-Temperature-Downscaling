...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Train the PCR-Net ablation without the gradient guidance loss.")
...
def main():
    ...
    train_pure_mse_ablation(args, config, "no-gradient-loss")
